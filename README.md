...
| `--json`                                   | Emit machine-readable JSON-lines progress on **stdout** (human logs stay on stderr). Useful for automation.                                                                                                                                                                                                                                                                                                                                                                            |
...
faostatdb build --yes --json > build-events.jsonl          # machine-readable log
```
...
faostatdb build --include QCL --years 2019- --keep-archives --yes  # add all years >= 2019
```
